...
const Article =   function (){
    ...
    return isError? <ErrorPage statusCode={'404'} message={'Maaf Artikel Tidak Ditemukan'}/>:<div className=" relative  w-full ">
            <HomepageNav/> 
            <ToastContainer/>
        ...
        {  
            post == null ? <div className=" absolute top-1/2 left-1/2"><Loading/></div> : <div className="  h-full w-full max-w-6xl lg:pr-4  lg:items-start items-center  lg:flex justify-center grid grid-cols-1 lg:flex-row  mx-auto mb-4">
            {post == null ? <Loading/> : 
