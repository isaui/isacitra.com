...
const Article =   function (){
    ...
    return isError?  <ErrorPage statusCode={'500'} message={'Maaf Terjadi Kesalahan Dalam Memuat Artikel'}/>:<div className=" ">
        ...
        <div className={`  flex justify-center  ${isCommentOpen? 'bg-black bg-opacity-40' : ''} flex-wrap flex-col items-center w-full`}>
        ...
        {  
            ...
            <div className="  py-3 h-min  flex flex-col items-center justify-center space-y-4  md:mb-auto md:min-h-[150px] rounded-lg w-full mx-auto md:mr-4 md:ml-0 my-4 md:mt-0">
