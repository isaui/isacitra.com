...
export default function(){
    ...
    return (<>
    <ToastContainer/>
        <div className="bg-slate-800 rounded-xl mt-6 grid grid-cols-4 gap-2 lg:gap-8 mb-12">
            <div className="lg:order-2 order-1 bg-slate-800 lg:bg-opacity-0 mt-3 rounded-md lg:mt-0 bg-opacity-30  pt-4 pb-3 lg:col-span-3 col-span-4 flex flex-col justify-center text-center mx-auto lg:text-left text-white w-full greeting-style">
        <div className=" font-bold"></div>
        <h1 className=" lg:ml-auto greeting-style pb-3 px-6 font-bold md:text-6xl sm:text-5xl text-4xl md:py-3">Video Conference<span className=" text-[#00A8FF]"> Gue</span></h1>
        ...
        <div className="lg:order-1 order-2   lg:mt-0  col-span-4 lg:col-span-1 flex flex-col justify-center items-center">
        <div className=" mb-1">
        <img className=" h-80 w-auto lg:h-96 "src={VideoCardImg} alt="" />
        </div>
        </div>
